...
@section('content')
    <div class="intro-slider-container mb-5">
        <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" 
            ...
            <div class="intro-slide" style="background-image: url({{ asset('images/demos/demo-4/slider/slide-1.png') }});">
                <div class="container intro-content">
                    <div class="row justify-content-end">
                        <div class="col-auto col-sm-7 col-md-6 col-lg-5">
                            <h3 class="intro-subtitle text-third mb-2">Para artistas</h3><!-- End .h3 intro-subtitle -->
                            <h1 class="intro-title">Tabletas</h1>
                            <h1 class="intro-title">de dibujo</h1><!-- End .intro-title -->
                            ...
                            <a href="category.html" class="btn btn-primary btn-round mt-4">
                                <span>Ver más</span>
            ...
            <div class="intro-slide" style="background-image: url({{ asset('images/demos/demo-4/slider/slide-2.png') }});">
                <div class="container intro-content">
                    <div class="row justify-content-end">
                        <div class="col-auto col-sm-7 col-md-6 col-lg-5">
                            <h3 class="intro-subtitle text-primary mb-2">Gusto musical</h3><!-- End .h3 intro-subtitle -->
                            <h1 class="intro-title">Audífonos <br>de alta gama </h1><!-- End .intro-title -->
    ...
    <div class="container">
        <h2 class="title text-center mb-4">Catálogos más visitados</h2><!-- End .title text-center -->
            ...
            <div class="row">
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('images/demos/demo-4/cats/1.png') }}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('images/demos/demo-4/cats/2.png') }}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('images/demos/demo-4/cats/3.png') }}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('images/demos/demo-4/cats/4.png') }}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('images/demos/demo-4/cats/5.png') }}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('images/demos/demo-4/cats/6.png') }}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('images/demos/demo-4/products/product-1.jpg') }}" alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('images/demos/demo-4/products/product-2.jpg') }}" alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('images/demos/demo-4/products/product-3.jpg') }}" alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('images/demos/demo-4/products/product-4.jpg') }}" alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            <span class="product-label label-circle label-top">Top</span>
                            <a href="product.html">
                                <img src="{{ asset('images/demos/demo-4/products/product-5.jpg') }}" alt="Product image" class="product-image">
                            </a>
